...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // Initialize Parse
        Parse.setApplicationId("6mra406SCjydcQzaWt7XbBwq6xSbZD4JHamZzGSr", clientKey: "JcYzvlY8xuKGjP5eYRZfgwz8V6nabyoaVZV7eFtn")
...
//            initialViewController = storyboard.instantiateViewControllerWithIdentifier("PageController") as! UIViewController
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.vincentleeuwen.BitDateAmsterdam" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("BitDateAmsterdam", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("BitDateAmsterdam.sqlite")
